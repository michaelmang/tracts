...
export default function Hero({ author, children, image }) {
  return (
    <div className="w-full header p-4 md:p-10 md:pl-12 pt-4" style={{ "--header-background": `url('${image}')`}}>
        ...
        <div className="w-full h-full flex flex-col items-center justify-end">
          <WindupChildren>
            <Pace getPace={(char) => (char === " " ? 40 : 20)}>
              ...
              <div className="text-white text-xs md:text-sm mb-2"><span className="font-bold">Written By:</span> {author}</div>
